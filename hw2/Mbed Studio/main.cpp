...
public:
    ...
    void run()
    {
        ...
        //     return;
        // }
        // _socket.set_hostname("ntu.im");
#endif // MBED_CONF_APP_USE_TLS_SOCKET

        /* now we have to find where to connect */

#define my_addr "10.10.10.10"
#define my_port 65431
        SocketAddress address(my_addr, my_port);

        // if (!resolve_hostname(address)) {
        //     return;
        // }

        // address.set_port(my_port);
